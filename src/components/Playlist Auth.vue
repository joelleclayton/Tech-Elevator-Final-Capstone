      ...
      <table class="display-playlist">
        <tr>
          ...
          <th class="rightest-cell">Artist</th>
                    <th class="rightest-cell">Play</th>
                    <th class="rightest-cell">Play Next</th>
        ...
        <tr v-for="song in this.$store.state.playlist"
          ...
          <td>{{song.title}}</td>
          <td>{{song.artist}}</td>
          <td><button type="submit" class="djq btn btn-submit" v-on:click.prevent="playSong(song)">></button></td>
          <td><button type="submit" class="djq btn btn-submit" v-on:click.prevent="playNext(song)">>></button></td>
